...
export const skills = {
  Languages: 'Java, Python, OCaml, JavaScript, TypeScript, React',
  Frameworks: 'Next.js, React, Node.js, Flask, Django, Tailwind',
  'AI & Data': 'LangChain, OpenAI APIs, scikit-learn, n8n',
  Infra: 'Git, Docker, AWS, PostgreSQL, MongoDB',
}
